...
SESSION_CONFIGS = [
    dict(name='Study', app_sequence=['A_Introduction','B_Tasks', 'Z_Results'], num_demo_participants=100,
         completionlink='https://app.prolific.com/submissions/complete?cc=CJVUV8Y1'), 
